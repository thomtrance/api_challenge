 ...
 * Modified by Thom Sanford 8/1/2016
 */
@Component
public class PetLoader implements InitializingBean {
	...
	/**
	 * This method is used to create the original data table for dog entries 
	 * 
	 */
	...
	/**
	 * This method is used to load from suplied resources the individual records into the dog data table  
	 * 
	 */
